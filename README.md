...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  @media (min-width: 860px) {
    .app-shell { padding: 2.4rem 1.5rem 3.5rem; }
    .container { max-width: 860px; }
    .header-banner { padding: 2.6rem 2rem 2.1rem; }
    ...
    .panel-col-form { position: sticky; top: 1.5rem; }
    .stats-grid { grid-template-columns: repeat(3, 1fr); }
    .week-grid { grid-template-columns: repeat(7, 1fr); }
  }

  @media (max-width: 380px) {
    .app-shell { padding: 0.8rem 0.6rem 2.4rem; }
    .header-banner { padding: 1.6rem 1rem 1.4rem; border-radius: 20px; }
    .header-banner h1 { font-size: 1.65rem; }
    .header-banner p { font-size: 0.82rem; }
    .stats-grid { grid-template-columns: repeat(2, 1fr); }
    .stat-value { font-size: 1.25rem; }
    .field-group { min-width: 100%; }
    .action-btn { font-size: 0.8rem; padding: 0.7rem 0.4rem; }
    .tab-btn { font-size: 0.82rem; padding: 0.55rem 0.3rem; }
    .mode-btn { font-size: 0.78rem; padding: 0.5rem 0.3rem; }
    .bead { width: 11px; height: 11px; }
  }
